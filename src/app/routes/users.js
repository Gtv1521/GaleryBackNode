...
import { consultaUsers, deleteUser, updateMail,   updateUser, updatePassword, consultarUser } from '../controller/user.controller.js';
 ...
 *             message: Access denied                               
 */
router.get('/user/:id', verifyToken, consultarUser);
